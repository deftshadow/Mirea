...
#include "calculator.h"
    ...
    mainLayout->addWidget(exponentialButton, 1, 6, 1, 1);
    ...
    mainLayout->addWidget(sinButton, 5, 6);
    mainLayout->addWidget(cosButton, 4, 6);
    mainLayout->addWidget(lnButton, 3, 6);
    mainLayout->addWidget(logButton, 2, 6);

    mainLayout->addWidget(tanButton, 6, 6);
    mainLayout->addWidget(leftbracketButton, 6, 4);
    mainLayout->addWidget(rightbracketButton, 6, 5);
